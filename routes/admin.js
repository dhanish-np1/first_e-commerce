...
//=================================products=====================================================
adminRouter.get('/addproducts',isAuth.isLogin,productcontroller.loadAddProduct)
...
adminRouter.get('/loadeditproduct',isAuth.isLogin,productcontroller.loadEditProduct)
adminRouter.post('/editproduct',isAuth.isLogin,multer.productImagesUpload,productcontroller.editProduct)
//=================================catogery=====================================================
